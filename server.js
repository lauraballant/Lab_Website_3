...
app.get('/team_stats', function(req, res) {
  ...
  .then(stats => {
      res.render('pages/team_stats', {
        ...
        list_games: stats[0],
        win_count: stats[1][0].count,
        loss_count: stats[2][0].count
    })
  })
  .catch(error => {
      request.flash('error', err);
...
app.get('/player_info', function(req,res) {
  var 
  var query = "select id as id, name as player_name from football_players;";
  db.any(query) 
      .then(function(rows) {
...
app.get('/player_info/select_player', function(req,res) {
  ...
  var query1 = "select id as id, name as player_name from football_players;";
  var query2 = "select * from football_players where id =''"+ player_id"';";
  var query3 = "select count(*) from football_players inner join football_games on football_players.id = any(football_games.players) where football_players.id = '" + player_id + "';";
